            ...
            <div class="memory-category-filters">
              ...
              <select class="memory-sort-select" id="email-lib-filter" style="flex:1;min-width:0;">
                ...
                <optgroup label="Tags">
                  ...
                  <option value="tag:job-applications">Job applications</option>
                  <option value="tag:job-recruiter">Job · Recruiter</option>
                  <option value="tag:job-application-update">Job · Application update</option>
                  <option value="tag:job-interview">Job · Interview</option>
                  <option value="tag:job-assessment">Job · Assessment</option>
                  <option value="tag:job-rejection">Job · Rejection</option>
                  <option value="tag:job-offer">Job · Offer</option>
